class ProductsWithCategoryResponse {
  List<Categories>? categories;
  String? count;

  ProductsWithCategoryResponse({this.categories, this.count});

  ProductsWithCategoryResponse.fromJson(Map<String, dynamic> json) {
